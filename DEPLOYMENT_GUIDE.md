...
4. Enable the **Email/Password** provider (leave _Email link (passwordless sign-in)_ disabled for now).
5. Click **Save**.
...
- _Alternatively_, if you need a direct installable APK for side-loading:
  ```bash
