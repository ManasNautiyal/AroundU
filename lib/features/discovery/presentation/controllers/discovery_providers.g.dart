...
/// See also [SelectedVibeFilter].
@ProviderFor(SelectedVibeFilter)
final selectedVibeFilterProvider =
    AutoDisposeNotifierProvider<SelectedVibeFilter, String?>.internal(
      SelectedVibeFilter.new,
      name: r'selectedVibeFilterProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$selectedVibeFilterHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
