...
/// Dynamically resolves a string containing a photo (either a URL or Base64 data)
...
ImageProvider getUserImageProvider(String url) {
  ...
  return NetworkImage(cleanUrl.isEmpty 
...
Future<String> compressAndEncodeImage(String path) async {
  ...
  // Resize using Flutter's native image codec
