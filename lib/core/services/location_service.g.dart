...
String _$userPositionHash() => r'19fc9acc099055a510afa1c31856ba29543c7a0c';

/// See also [userPosition].
@ProviderFor(userPosition)
final userPositionProvider = AutoDisposeStreamProvider<Position>.internal(
  userPosition,
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef UserPositionRef = AutoDisposeStreamProviderRef<Position>;
